...
export const wallArtLanding: WallArtLanding = {
  ...
  description:
    'Buy Scandinavian art prints by five independent Norwegian and Swedish artists. Twenty Nordic prints, each framed in wood, black or white, or unframed, made to order.',
  heading: 'Buy Scandinavian Art Prints',
  intro:
    "This page is the whole gallery: twenty Scandinavian art prints, every one by an artist living and working in Norway or Sweden, and every one sold framed or unframed. Helene Brox paints pared-back cream figures in Oslo and cuts a swallow down to the plunge of its wings. Ingunn Dybendal draws folk flowers and patterned lakeland in coloured pencil, Sia Siamos crowds tables with lobster, wine and cabin breakfasts, Simen Wahlqvist fits an entire joke into a handful of lines, and Hedvig Wallin sets a Gothenburg breakfast table in ink and watercolour. Five hands, four styles, and not a filler print among them.",
  intro2:
  ...
  faqs: [
    {
      ...
      answer:
        'Right here, from the gallery itself rather than a marketplace. We work directly with five independent artists in Oslo, Bergen and Gothenburg, and each print is made to order when you buy it: pick the size and the frame on the product page and it goes to print for you.',
    },
    {
