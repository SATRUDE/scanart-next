...
export const wallArtLanding: WallArtLanding = {
  ...
  description:
    'Buy Scandinavian art prints by independent artists from across the Nordics: framed in wood, black or white, or unframed, and made to order.',
  heading: 'Buy Scandinavian Art Prints',
  intro:
    "This page is the whole gallery: Nordic art prints, every one by an independent artist living and working in the Nordics, and every one sold framed or unframed. Helene Brox paints pared-back cream figures in Oslo and cuts a swallow down to the plunge of its wings. Ingunn Dybendal draws folk flowers and patterned lakeland in coloured pencil, Sia Siamos crowds tables with lobster, wine and cabin breakfasts, Simen Wahlqvist fits an entire joke into a handful of lines, Hedvig Wallin sets a Gothenburg breakfast table in ink and watercolour, and Mikko Saarainen fills every corner of a Finnish comic artist's page. Not a filler print among them.",
  intro2:
  ...
  faqs: [
    {
      ...
      answer:
        'Right here, from the gallery itself rather than a marketplace. We work directly with independent artists from across the Nordics, and each print is made to order when you buy it: pick the size and the frame on the product page and it goes to print for you.',
    },
    {
    ...
    },
    {
      ...
      answer:
        "Most prints are 50 x 70 cm or 50 x 50 cm squares. Each product page lists the sizes for that piece; as a rule of thumb, the larger formats hold a sofa or bed wall alone, and the smaller ones sit happily on a picture shelf or in a group.",
    },
    {
