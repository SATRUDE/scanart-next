...
export const wallArtLanding: WallArtLanding = {
  ...
  description:
    'Buy Scandinavian art prints by six independent artists in Norway, Sweden and Finland. Twenty-four Nordic prints, framed or unframed, made to order.',
  heading: 'Buy Scandinavian Art Prints',
  intro:
    "This page is the whole gallery: twenty-four Nordic art prints, every one by an artist living and working in Norway, Sweden or Finland, and every one sold framed or unframed. Helene Brox paints pared-back cream figures in Oslo and cuts a swallow down to the plunge of its wings. Ingunn Dybendal draws folk flowers and patterned lakeland in coloured pencil, Sia Siamos crowds tables with lobster, wine and cabin breakfasts, Simen Wahlqvist fits an entire joke into a handful of lines, Hedvig Wallin sets a Gothenburg breakfast table in ink and watercolour, and Mikko Saarainen fills every corner of a Finnish comic artist's page. Six hands, five styles, and not a filler print among them.",
  intro2:
    "Buying Scandinavian art prints online usually means scrolling a marketplace of ten thousand posters that have never been within a thousand miles of a fjord. This is the opposite. A small gallery, six artists we work with directly, and every print made to order rather than pulled from a warehouse. Choose the piece first and the frame second, and if you can't choose between two, Wahlqvist's squares and Brox's pair of bird prints are built to hang together.",
  ...
  faqs: [
    {
      ...
      answer:
        'Right here, from the gallery itself rather than a marketplace. We work directly with six independent artists in Oslo, Bergen, Gothenburg and Lahti, and each print is made to order when you buy it: pick the size and the frame on the product page and it goes to print for you.',
    },
    {
    ...
    },
    {
      ...
      answer:
        "Most prints are 50 x 70 cm, and the square illustrations by Simen Wahlqvist and Mikko Saarainen are 50 x 50 cm. Each product page lists the sizes for that piece; as a rule of thumb, the larger formats hold a sofa or bed wall alone, and the smaller ones sit happily on a picture shelf or in a group.",
    },
    {
      question: 'Scandinavian, Nordic or Scandi: is there a difference?',
      answer:
        "Not one that matters when you're choosing a print. Scandinavian strictly means Norway, Sweden and Denmark; Nordic adds Finland and Iceland; Scandi is what everyone says by the third mention. The artists here live and work in Norway, Sweden and Finland, so Nordic is the precise word for the gallery and Scandinavian is the one most people type.",
    },
  ],
};
