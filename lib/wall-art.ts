  ...
  faqs: [
    {
      ...
      answer:
        'Right here, from the gallery itself rather than a marketplace. We work directly with independent Norwegian and Swedish artists, and each print is made to order when you buy it: pick the size and the frame on the product page and it goes to print for you.',
    },
    {
    ...
    },
    {
      ...
      answer:
        "Sizes vary by piece. Each product page lists the available formats; as a rule of thumb, the larger formats hold a sofa or bed wall alone, and the smaller ones sit happily on a picture shelf or in a group.",
    },
    {
      question: 'Scandinavian, Nordic or Scandi: is there a difference?',
      answer:
        "Not one that matters when you're choosing a print. Scandinavian strictly means Norway, Sweden and Denmark; Nordic adds Finland and Iceland; Scandi is what everyone says by the third mention. The artists here are Norwegian and Swedish, so the prints qualify under whichever word you searched for.",
    },
  ],
};
