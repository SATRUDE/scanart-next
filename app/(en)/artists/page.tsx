...
const PAGE_DESCRIPTION = 'Meet the artists behind the collection, a small group of illustrators and printmakers from across the Nordics.';
...
export default async function ArtistsPage() {
  ...
  // lead names no count and no country list (Mark, 2026-09-26: copy that goes
  // stale as artists join), and no artist share is stated on public pages.
  // The counts in the meta line come from the data.
  return (
    <div className="page-x pb-section">
      <PageHeader
        ...
        lead={
          <p>
            Meet the artists behind the collection, a small group of illustrators and printmakers from across the Nordics.
          </p>
        }
